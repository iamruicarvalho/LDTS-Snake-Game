...
1.	ArrowUp -> Change snake direction to Up / Move Up Menu
2.	ArrowDown -> Change snake direction to Down / Move Down Menu
3.	ArrowRight -> Change snake direction to Right
4.	ArrowLeft -> Change snake direction to Left


### PLANNED FEATURES

•	Menus -> user can select between a GUI menu by using ArrowUp, ArrowDown and ENTER to select the desired option, one of the option being restart on the pause menu, to restart the game.
